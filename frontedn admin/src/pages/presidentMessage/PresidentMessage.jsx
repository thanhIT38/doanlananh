...
const PresidentMessage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const allnewcurent = await getTochuc();
  ...
  const handleUpdate = async (index) => {
    const update = await updateTochuc(index, {
      phoneNumber,
      parcel,
      selectedImage,
      chairmanName,
    });
    const updatedData = await getTochuc();
    setShowquanly(updatedData);
    setModalOpen(false);
  };

  const handleRemove = async (index) => {
    await deleteTochuc(index);
    const ud = getTochuc();
  ...
  const handleCreate = async () => {
    const data = { phoneNumber, parcel, selectedImage, chairmanName };
    const respon = await createTochuc(data);
    const ud = getTochuc();
    setShowquanly(ud);
    setModalOpen(false);
  };
          ...
          {showquanly?.data?.data.map((teacher, index) => (
            ...
            >
              ...
              <div className="teachers-card-identity">
                ...
                <h5>Bưu kiện :{teacher.buukien}</h5>
                ...
                <form>
                  ...
                  <div className="form-group flex flex-wrap my-2 items-center">
                    ...
                    <input
                      ...
                      name="chairmanName"
                      value={chairmanName}
                      onChange={(e) => handleInputChange(e, setChairmanName)}
                    />
                  </div>
                  ...
                  <div className="form-group flex flex-wrap my-2 items-center">
                    ...
                    <input
                      ...
                      id="position"
                      name="parcel"
                      placeholder="Bưu kiện"
                      value={parcel}
                      onChange={(e) => handleInputChange(e, setParcel)}
                    />
                  </div>
