...
const WaitingStudents = () => {
  ...
  const tableRows = [
    { date: '11 - 10 - ২০২২', content: 'Danh sách chờ tuyển sinh 2022'},
  ];
    ...
    <React.Fragment>
      <div id="waitingStudents">
        <div className="pages-title my-4 bg-gradient-to-r from-[rgba(244,254,255,1)] to-[rgba(161,182,182,1)] text-center flex flex-col items-center py-4">
          <h3 className='bg-[#79929C] text-lg font-medium my-2 text-white px-14 sm:px-14 py-2'>Danh sách sinh viên chờ nhập học</h3>
