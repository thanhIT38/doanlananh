...
const AdmissionNotice = () => {
  ...
  const tableRows = [
   { date: '10 - 1 - 2023', content: 'Mẫu bài kiểm tra thông báo gần đây' },
{ date: '10 - 9 - 2015', content: 'Tuyển nhân viên hành chính đặc biệt.' },
{ ngày: '11 - 10 - 2013', content: 'Mẫu đơn đăng ký kiểm tra chứng chỉ' },
{ date: '11 - 10 - 2013', content: 'Kỳ thi tuyển giáo viên tiểu học' },
  ];
