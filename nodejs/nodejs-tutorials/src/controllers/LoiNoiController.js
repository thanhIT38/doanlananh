...
export const createLoiNoiController = async (req, res) => {
    const { content } = req.body;
    if (content) {
        const response = await createLoiNoiService({ content });
...
export const getAllLoiNoiController = async (req, res) => {
    try {
        const response = await getAllLoiNoiService();
