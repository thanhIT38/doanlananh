...
const ClassRoutine = () => {
  // Table Row
  const tableRows = [
    { date: '10 - 1 - 2023', content: 'Nội quy lớp học tiểu học' },
    { date: '10 - 9 - 2015', content: 'Nội quy lớp học cấp hai' },
    { date: '11 - 10 - 2013', content: 'Lớp học thường lệ' },
    { date: '11 - 10 - 2013', content: 'nội lệ lớp học' },
  ];
    ...
    <React.Fragment>
      <div id="classRoutine">
        ...
        <div className="pages-title my-4 bg-gradient-to-r from-[rgba(244,254,255,1)] to-[rgba(161,182,182,1)] text-center flex flex-col items-center py-4">
          <h3 className='bg-[#79929C] text-lg font-medium my-2 text-white px-14 sm:px-14  py-2'>thói quen lớp học</h3>
