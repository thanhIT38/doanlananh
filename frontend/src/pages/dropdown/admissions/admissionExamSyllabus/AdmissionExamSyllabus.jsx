...
const AdmissionExamSyllabus = () => {
  ...
  const tableRows = [
    { date: '10 - 1 - 2023', content: 'Đề cương thi tuyển sinh 2023' },
  ];
    ...
    <React.Fragment>
      <div id="admissionExamSyllabus">
        <div className="pages-title my-4 bg-gradient-to-r from-[rgba(244,254,255,1)] to-[rgba(161,182,182,1)] text-center flex flex-col items-center py-4">
          <h3 className='bg-[#79929C] text-lg font-medium my-2 text-white px-14 sm:px-14 py-2'>Bài kiểm tra đầu vào giáo trình</h3>
