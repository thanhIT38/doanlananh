      ...
      <div id="navbar">
        ...
        >
          <ul className="flex justify-around items-center">
            ...
            <li
              className={`relative ${
                location.pathname === "/students" ? "đã chọn" : ""
              }`}
            >
            ...
            <li
              className={`relative ${
                location.pathname === "/contact" ? "đã chọn" : ""
              }`}
            >
